...
<div class="container">
            ...
            <table class="table">
                ...
                <?php foreach ($urlsList as $url) :?>
                    <tr>
                        ...
                        <td><a class="btn btn-primary" href="/admin/url/remove/<?php echo $url['id'];?>" role="button">Remove</a></td>
                    </tr>
                <?php endforeach;?>
                </tbody>
            </table>
    ...
    <div class="row">
        <div class="col">
            <form action="/admin/url/add" method="post">
                <div class="mb-3">
                    <input type="text" class="form-control" name="url">
                </div>
                <div class="mb-3">
                    <button type="submit" value=" Send" class="btn btn-primary" id="submit">Add url</button>
                </div>
            </form>
        </div>
    </div>
